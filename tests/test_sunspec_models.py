...
class TestBuildInitialRegisters:
    ...
    def test_returns_177_items(self):
        from pv_inverter_proxy.sunspec_models import build_initial_registers
    ...
    def test_manufacturer_fronius(self):
        from pv_inverter_proxy.sunspec_models import build_initial_registers, encode_string
        regs = build_initial_registers()
...
class TestApplyCommonTranslation:
    ...
    def test_replaces_manufacturer(self):
        from pv_inverter_proxy.sunspec_models import apply_common_translation, encode_string
    ...
    def test_replaces_device_address(self):
        from pv_inverter_proxy.sunspec_models import apply_common_translation
        se_regs = [0] * 67
...
class TestConstants:
    ...
    def test_datablock_start(self):
        from pv_inverter_proxy.sunspec_models import DATABLOCK_START
        assert DATABLOCK_START == 40001

    def test_total_registers(self):
        from pv_inverter_proxy.sunspec_models import TOTAL_REGISTERS
