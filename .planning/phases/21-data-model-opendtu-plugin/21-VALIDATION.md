...
| 21-02-01 | 02 | 2 | DTU-01, DTU-02, DTU-04 | unit | `uv run python -m pytest tests/test_opendtu_plugin.py -x -q` | ❌ W0 | ⬜ pending |
| 21-02-02 | 02 | 2 | DTU-03, DTU-05 | unit | `uv run python -m pytest tests/test_opendtu_plugin.py -x -q` | ❌ W0 | ⬜ pending |
...
- [ ] `tests/test_opendtu_plugin.py` — stubs for DTU-01 through DTU-05 (plugin poll, power limit, dead-time)
